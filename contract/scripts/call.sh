...
SIGNER=aricha.testenet

source ./scripts/setting.conf


# Add record to patient records
near call $SUB_ACCOUNT add_record '{"diagnosis": "Diarrhea", 
                                    "hospital_name": "CGH", 
                                    "medicine_administered": "Flagyl", 
                                    "date_of_admission": 21/04/2022, 
                                    "date_of_release": "21/05/2022", 
                                    "allergies_recorded": "Protein Allergies"
                                    "price": "1000", }' 
                                    --accountId $SIGNER --amount 1
